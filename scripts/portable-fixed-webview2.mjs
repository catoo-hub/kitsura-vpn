...
async function resolvePortable() {
  ...
  zip.addLocalFile(path.join(releaseDir, "Kitsura VPN.exe"));
  zip.addLocalFile(path.join(releaseDir, "kitsura-core.exe"));
  zip.addLocalFile(path.join(releaseDir, "kitsura-core-alpha.exe"));
