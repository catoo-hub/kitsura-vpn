...
function clashMetaAlpha() {
  ...
  return {
    name: "kitsura-core-alpha",
    targetFile: `kitsura-core-alpha-${SIDECAR_HOST}${isWin ? ".exe" : ""}`,
    exeFile,
    zipFile,
    downloadURL,
  };
...
function clashMeta() {
  ...
  return {
    name: "kitsura-core",
    targetFile: `kitsura-core-${SIDECAR_HOST}${isWin ? ".exe" : ""}`,
    exeFile,
    zipFile,
    downloadURL,
  };
...
const resolveService = () => {
  ...
  resolveResource({
    file: "kitsura-service" + suffix + ext,
    downloadURL: `${SERVICE_URL}/kitsura-service${ext}`,
  });
};
