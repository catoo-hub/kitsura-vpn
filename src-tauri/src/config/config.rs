...
pub const RUNTIME_CONFIG: &str = "kitsura-vpn.yaml";
pub const CHECK_CONFIG: &str = "kitsura-vpn-check.yaml";
...
impl Config {
    ...
    pub fn generate_file(typ: ConfigType) -> Result<PathBuf> {
        ...
        help::save_yaml(&path, &config, Some("# Generated by Kitsura VPN"))?;
        Ok(path)
    }
