...
pub static APP_ID: &str = "io.github.kitsura-vpn";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "io.github.kitsura-vpn-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.kitsura-vpn.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "io.github.kitsura-vpn-backup-dev";
...
pub fn service_path() -> Result<PathBuf> {
    ...
    Ok(res_dir.join("kitsura-service"))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    let res_dir = app_resources_dir()?;
    Ok(res_dir.join("kitsura-service.exe"))
}
